...
df_prod, df_prod_pct, df_mean_pct, df_asset, sub_df_asset=Extract(prod_path=prod, prod_pct_path=prod, 
...
asset_vmr_planif=TransformAsset(data_prod=df_prod, 
                                prod_pct=df_prod_pct, mean_pct=df_mean_pct, 
                                sub_asset=sub_df_asset, profile=df_prod_pct, asset=df_asset
                               )
...
Load(dest_dir=dest_dir, src_flow=asset_vmr_planif, file_name="asset_vmr_planif")
